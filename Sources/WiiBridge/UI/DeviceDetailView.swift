    ...
    var standardVisualizer: some View {
        VStack(alignment: .leading) {
            ...
            LazyVGrid(columns: [GridItem(.adaptive(minimum: 100))]) {
                ...
                IndicatorView(label: "X", active: wiiState.buttonX)
                IndicatorView(label: "Y", active: wiiState.buttonY)
                IndicatorView(label: "1", active: wiiState.buttonOne)
                IndicatorView(label: "2", active: wiiState.buttonTwo)
                IndicatorView(label: "L", active: wiiState.buttonL)
                IndicatorView(label: "R", active: wiiState.buttonR)
                IndicatorView(label: "ZL", active: wiiState.buttonZL)
                IndicatorView(label: "ZR", active: wiiState.buttonZR)
                IndicatorView(label: "C", active: wiiState.buttonC)
                IndicatorView(label: "Z", active: wiiState.buttonZ)
